<x-blog title="Blog create">
    ...
    <form action="{{ route('blog.store') }}" method="post" enctype="multipart/form-data">
        ...
        <div class="mb-3">
            <label for="formVideo" class="form-label">Video</label>
            <input name="url_video" class="form-control" type="file" id="formVideo">
        </div>

        <div class="mb-3">
            <label for="formUrl" class="form-label">Url</label>
            <input name="url" class="form-control" type="text" id="formUrl">
        </div>
