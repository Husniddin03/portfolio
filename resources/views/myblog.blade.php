        ...
        <div class="container">
            <div class="row align-items-center">
                ...
                <div class="col-md-8 mx-auto text-center">
                    <h1 class="blog-heading" data-aos="fade-up" data-aos-delay="0">A HTML Guide For Beginners
                    </h1>
                    <div class="post-meta" data-aos="fade-up" data-aos-delay="100">By Joefrey on March 15, 2020
                        &bullet; 5 mins read</div>
                </div>
        ...
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-md-7">
                    ...
                    <p>
                        <img src="{{asset('images/work_1_a_full.jpg')}}" alt="Image" class="img-fluid">
                    </p>
                    <p>
                    ...
                    <p>
                        <img src="{{asset('images/work_1_full.jpg')}}" alt="Image" class="img-fluid">
                    </p>
                    <p>
                    ...
                    <div class="pt-5">
                        ...
                        <ul class="comment-list">
                            ...
                            <li class="comment">
                                <div class="vcard bio">
                                    <img src="{{asset('images/person_woman_1.jpg')}}" alt="Image placeholder">
                                </div>
                                <div class="comment-body">
                                ...
                                <ul class="children">
                                    <li class="comment">
                                        <div class="vcard bio">
                                            <img src="{{asset('images/person_man_3.jpg')}}" alt="Image placeholder">
                                        </div>
                                        <div class="comment-body">
                                            <h3>Chintan Patel</h3>
                                            <div class="meta">January 9, 2018 at 2:21pm</div>
                                        ...
                                        <ul class="children">
                                            <li class="comment">
                                                <div class="vcard bio">
                                                    <img src="{{asset('images/person_man_2.jpg')}}" alt="Image placeholder">
                                                </div>
                                                <div class="comment-body">
                                                    <h3>John Doe</h3>
                                                    <div class="meta">January 9, 2018 at 2:21pm</div>
                                                ...
                                                <ul class="children">
                                                    <li class="comment">
                                                        <div class="vcard bio">
                                                            <img src="{{asset('images/person_man_1.jpg')}}" alt="Image placeholder">
                                                        </div>
                                                        <div class="comment-body">
                                                            <h3>Ben Afflick</h3>
                                                            <div class="meta">January 9, 2018 at 2:21pm</div>
                            ...
                            <li class="comment">
                                <div class="vcard bio">
                                    <img src="{{asset('images/person_woman_3.jpg')}}" alt="Image placeholder">
                                </div>
                                <div class="comment-body">
                                    <h3>Jean Doe</h3>
                                    <div class="meta">January 9, 2018 at 2:21pm</div>
